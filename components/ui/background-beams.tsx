...
export const BackgroundBeams = React.memo(
    ({ className }: { className?: string }) => {
        ...
        return (
            <div
                className={cn(
                    "absolute h-full w-full inset-0 [mask-image:radial-gradient(ellipse_at_center,black_80%,transparent_100%)] flex items-center justify-center pointer-events-none",
                    className,
                )}
            >
                <svg
                    ...
                    <defs>
                        {paths.map((path, index) => (
                            ...
                            >
                                ...
                                <stop stopColor="black" stopOpacity="1" offset="20%"></stop>
                                <stop offset="50%" stopColor="#0e260a" stopOpacity="1"></stop>
