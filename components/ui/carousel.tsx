            ...
            >
                ...
                >
                    <h2 className="text-lg md:text-2xl lg:text-4xl font-semibold  relative">
                        {restOfTitle}{restOfTitle && ' '}<span className="text-brand-500">{lastWord}</span>
                    </h2>
...
const CarouselControl = ({
    ...
    return (
        <button
            className={`w-10 h-10 flex items-center mx-2 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-brand-500 focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${type === "previous" ? "rotate-180" : ""
                }`}
            title={title}
            onClick={handleClick}
        >
